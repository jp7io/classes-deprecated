...
<div class="krumo-root">
	<ul class="krumo-node krumo-first">
		<div style="float:right;background:white;line-height:24px;color:black;padding:0px 4px;cursor:pointer;position:relative;margin-right:-20px;left:-20px;" title="Expandir" onclick="$('.krumo-expand:not(.krumo-opened)', $(this).parent()).each(function(){krumo.toggle(this);})">+</div>
